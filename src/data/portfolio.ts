...
export const projects: Project[] = [
  {
    ...
    category: 'ai',
    images: ['/images/RAG-Home.png', '/images/RAG-chat.png', '/images/RAG-pannel.png'],
    githubUrl: 'https://github.com/bhoomik-codes/ragify',
    featured: true,
    year: '2025',
    readmeUrl: '/readme/ragify_README.md',
  },
  {
    id: 'campus-echo',
    ...
    category: 'web',
    images: ['/images/campusecho-client.png', '/images/campusecho-admin.png'],
    githubUrl: 'https://github.com/bhoomik-codes/campus-echo',
    featured: true,
    year: '2025',
    readmeUrl: '/readme/campusecho_README.md',
  },
  {
    id: 'trustflow',
    ...
    category: 'fullstack',
    images: ['/images/trustflow.png'],
    githubUrl: 'https://github.com/bhoomik-codes/trustflow-finance',
    featured: true,
    year: '2026',
    readmeUrl: '/readme/trustflow_README.md',
  },
  {
    id: 'kurumi',
    ...
    category: 'ai',
    images: ['/images/kurumi_models_page.png', '/images/kurumi_model_store.png', '/images/kurumi_chat_markdown.png', '/images/kuumi_chat_empty.png'],
    githubUrl: 'https://github.com/bhoomik-codes/kurumi',
    featured: true,
    year: '2025',
    readmeUrl: '/readme/kurumi_README.md',
  },
  {
    id: 'office-erp',
    ...
    category: 'tools',
    images: ['/images/office-erp-system.png'],
    githubUrl: 'https://github.com/bhoomik-codes/erp-face',
    featured: false,
    year: '2024',
    readmeUrl: '/readme/office_erp_README.md',
  },
  {
    id: 'zomato-analysis',
    ...
    category: 'ai',
    images: ['/images/zomato_analysis.png'],
    githubUrl: 'https://github.com/bhoomik-codes/zomato-analysis',
    featured: false,
    year: '2023',
    readmeUrl: '/readme/zomato_README.md',
  }
];
